...
local tools_by_ft = {
	...
	kdl = {}, -- highlighting is provided by Tree-sitter; kdl-lsp is not in Mason
	dosini = {}, -- generic *.conf files have no universal language server
	md = { "marksman", "markdownlint" },
