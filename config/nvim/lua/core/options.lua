...
local terminal_direction = "horizontal" -- horizontal / vertical / float
-- Keep Vim's regex highlighting as a fallback while a Tree-sitter parser is
-- missing or still being installed. Tree-sitter takes precedence once active.
vim.opt.syntax = "on"
vim.opt.mouse = ""
vim.opt.number = true
...
return {
	border = border,
	termianl_direction = terminal_direction,
}
