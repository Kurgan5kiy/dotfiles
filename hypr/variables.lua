...
return {
	...
	-- Modifier only; the actual binds are modifier + 0-9.
	kbGoToWs = "SUPER",
	...
	kbMoveWinToMusicWs = "SUPER + SHIFT + M",
	kbMoveWinToCommunicationWs = "SUPER + SHIFT + D",
	...
	kbVolumeMute = "CTRL + SUPER + SHIFT + M",
